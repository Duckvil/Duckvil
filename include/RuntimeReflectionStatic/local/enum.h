...
namespace Duckvil { namespace RuntimeReflection {
    ...
    DUCKVIL_RESOURCE(enum_t) get_enum_handle(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(ntype_t) _typeHandle, const char (&_sName)[Length])
    {
    ...
    DUCKVIL_RESOURCE(enum_t) get_enum_handle(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(ntype_t) _typeHandle)
    {
    ...
    // TODO: Not sure
    const __enum_t& get_enum(__ftable* _pReflection, __data* _pData, std::size_t _ullTypeID, DUCKVIL_RESOURCE(ntype_t)* _pTypeHandle = nullptr, DUCKVIL_RESOURCE(enum_t)* _pHandle = nullptr);

    template <std::size_t Length>
    DUCKVIL_RESOURCE(enum_element_t) get_enum_element_handle(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(ntype_t) _typeHandle, DUCKVIL_RESOURCE(enum_t) _handle, const char (&_sName)[Length])
    {
        return _pReflection->m_fnGetNEnumElementHandleByName(_pData, _typeHandle, _handle, _sName, Length);
    }

    template <typename Type>
    DUCKVIL_RESOURCE(enum_element_t) get_enum_element_handle(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(ntype_t) _typeHandle, DUCKVIL_RESOURCE(enum_t) _handle, const Type& _value)
    {
