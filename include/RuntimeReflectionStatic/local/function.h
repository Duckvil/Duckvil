...
namespace Duckvil { namespace RuntimeReflection {
    ...
    DUCKVIL_RESOURCE(function_t) get_function_handle(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, const char (&_sName)[Length])
    {
    ...
    template <typename Type, typename... Args>
    DUCKVIL_RESOURCE(function_t) get_function_handle(__ftable* _pReflection, __data* _pData, void (*_fnCallback)(Args...))
    {
        const auto& _typeHandle = get_type<Type>(_pReflection, _pData);
...
// TODO: Check it
    template <typename... Args, std::size_t Length>
    __function<void(*)(Args...)>* get_static_function_callback(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, const char (&_sName)[Length])
    {
    ...
    __function<void(Type::*)(Args...)>* get_function_callback_m(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, const char (&_sName)[Length])
    {
    ...
    template <typename Type, typename... Args>
    __function<void(Type::*)(Args...)>* get_function_callback_m(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, DUCKVIL_RESOURCE(function_t) _functionHandle)
    {
    ...
    __function<ReturnType(Type::*)(Args...)>* get_function_callback_mr(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, const char (&_sName)[Length])
    {
    ...
    Memory::Vector<DUCKVIL_RESOURCE(function_t)> get_functions(__ftable* _pReflection, __data* _pData, const Memory::FreeList& _heap, DUCKVIL_RESOURCE(type_t) _typeHandle);

    Memory::Vector<DUCKVIL_RESOURCE(function_t)> get_functions(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle);

    const __function_t& get_function(__ftable* _pReflection, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, DUCKVIL_RESOURCE(function_t) _functionHandle);
