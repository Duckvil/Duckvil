...
namespace Duckvil { namespace Editor {
    ...
    struct EditorFTable
    {
        ...
        void (*m_fnPostInit)(RuntimeReflection::__ftable* _pRuntimeReflection, RuntimeReflection::__data* _pRuntimeReflectionData, const Memory::FreeList& _heap, void* _pData);
    };
