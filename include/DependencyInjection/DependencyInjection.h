...
namespace Duckvil { namespace DependencyInjection {
    ...
    public:
        ...
        bool Resolve(const RuntimeReflection::__duckvil_resource_type_t& _typeHandle, const RuntimeReflection::__duckvil_resource_constructor_t& _constructorHandle, void** _ppResolvedObject = nullptr) override;
    };
