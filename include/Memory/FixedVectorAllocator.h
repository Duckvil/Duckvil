...
//     }
    ...
    static inline void* fixed_vector_back(ftable* _pMemory, fixed_vector_allocator* _pAllocator)
    {
        return _pMemory->m_fnFixedVectorBack_(_pAllocator);
    }

    static inline void* fixed_vector_end(ftable* _pMemory, fixed_vector_allocator* _pAllocator)
    {
        return _pMemory->m_fnFixedVectorEnd_(_pAllocator);
    }

    static inline void* fixed_vector_at(ftable* _pMemory, fixed_vector_allocator* _pAllocator, std::size_t _ullIndex)
    {
        return _pMemory->m_fnFixedVectorAt_(_pAllocator, _ullIndex);
    }

    template <typename Type>
    static inline Type* fixed_vector_at(ftable* _pMemory, fixed_vector_allocator* _pAllocator, std::size_t _ullIndex)
    {
        return static_cast<Type*>(fixed_vector_at(_pMemory, _pAllocator, _ullIndex));
    }

    static inline bool fixed_vector_empty(ftable* _pMemory, fixed_vector_allocator* _pAllocator)
    {
        return _pMemory->m_fnFixedVectorEmpty_(_pAllocator);
    }

    static inline bool fixed_vector_full(ftable* _pMemory, fixed_vector_allocator* _pAllocator)
    {
        return _pMemory->m_fnFixedVectorFull_(_pAllocator);
    }

    static inline void fixed_vector_resize(ftable* _pMemory, free_list_allocator* m_pParentAllocator, fixed_vector_allocator** _pAllocator, std::size_t _ullNewSize)
    {
        _pMemory->m_fnFixedVectorResize_(_pMemory, m_pParentAllocator, _pAllocator, _ullNewSize);
    }

    static inline std::size_t fixed_vector_size(ftable* _pMemory, fixed_vector_allocator* _pAllocator)
    {
        return _pMemory->m_fnFixedVectorSize_(_pAllocator);
    }

    static inline std::size_t fixed_vector_capacity(ftable* _pMemory, fixed_vector_allocator* _pAllocator)
    {
        return _pMemory->m_fnFixedVectorCapacity_(_pAllocator);
    }

    static inline void fixed_vector_erase(ftable* _pMemory, fixed_vector_allocator* _pAllocator, uint32_t _uiIndex)
    {
