...
namespace Duckvil { namespace Memory {
    ...
    static const size_t g_ullQueueNodeSize = sizeof(__queue_node);

    void* queue_allocate(__queue_allocator* _pAllocator, const void* _pData, size_t _ullSize, uint8_t _ucAlignment = 8);
