...
namespace Duckvil {
    ...
    {
        __logger_channel_data* (*init)(Memory::IMemory* _pMemoryInterface, Memory::__free_list_allocator* _pAllocator);
...
typedef Duckvil::__logger_channel_ftable* (*duckvil_logger_channel_init_callback)(Duckvil::Memory::IMemory* _pMemoryInterface, Duckvil::Memory::__free_list_allocator* _pAllocator);
...
DUCKVIL_EXPORT Duckvil::__logger_channel_ftable* duckvil_logger_channel_init(Duckvil::Memory::IMemory* _pMemoryInterface, Duckvil::Memory::__free_list_allocator* _pAllocator);