...
namespace Duckvil {
    ...
    public:
        ...
        Logger(const Memory::FreeList& _heap, const char* _sPath, std::size_t _ullPathLength, __logger_flags _flags)
        {
        ...
        Logger(const Memory::FreeList& _heap, const char (&_sPath)[Length], __logger_flags _flags) :
            Logger(_heap, _sPath, Length, _flags)
        {
