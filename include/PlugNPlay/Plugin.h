...
namespace Duckvil { namespace PlugNPlay {
    ...
    typedef void* (*allocator_callback)(Memory::IMemory* _pMemoryInterface, Memory::__free_list_allocator* _pAllocator);
    typedef void (*free_callback)(Memory::IMemory* _pMemoryInterface, Memory::__free_list_allocator* _pAllocator, void* _pointer);
...
#define DUCKVIL_PLUGIN(name) \
    void* construct(Duckvil::Memory::IMemory* _pMemoryInterface, Duckvil::Memory::__free_list_allocator* _pAllocator) \
    { \
