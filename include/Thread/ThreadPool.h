...
DUCKVIL_EXPORT Duckvil::Thread::pool_ftable* duckvil_thread_pool_init(Duckvil::Memory::IMemory* _pMemoryInterface, Duckvil::Memory::__free_list_allocator* _pAllocator);