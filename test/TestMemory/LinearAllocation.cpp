...
{
    {
        Duckvil::Memory::__linear_allocator* _linear = __duckvil_global::m_pMemoryInterface->m_fnLinearAllocateLinearAllocator((Duckvil::Memory::__linear_allocator*)__duckvil_global::m_pMemoryChunk, 1024 * 1024 * 1024);

        DUCKVIL_TEST_IS_NULL(_linear, "Hmm, allocated too much memory");
    }

    {
        Duckvil::Memory::__linear_allocator* _linear = __duckvil_global::m_pMemoryInterface->m_fnLinearAllocateLinearAllocator((Duckvil::Memory::__linear_allocator*)__duckvil_global::m_pMemoryChunk, 16);
