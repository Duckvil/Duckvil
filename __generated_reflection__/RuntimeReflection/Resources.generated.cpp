...
_property = record_property<Memory::Vector<__duckvil_resource_type_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetTypes), "m_fnGetTypes");
_property = record_property<Memory::Vector<__duckvil_resource_constructor_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*,Duckvil::RuntimeReflection::__duckvil_resource_type_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetConstructors), "m_fnGetConstructors");
...
_property = record_property<Memory::Vector<__duckvil_resource_property_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*,Duckvil::RuntimeReflection::__duckvil_resource_type_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetProperties), "m_fnGetProperties");
...
_property = record_property<Memory::Vector<__duckvil_resource_function_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*,Duckvil::RuntimeReflection::__duckvil_resource_type_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetFunctions), "m_fnGetFunctions");
...
_property = record_property<Memory::Vector<__duckvil_resource_argument_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*,Duckvil::RuntimeReflection::__duckvil_resource_type_t,Duckvil::RuntimeReflection::__duckvil_resource_constructor_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetConstructorArguments), "m_fnGetConstructorArguments");
...
_property = record_property<Memory::Vector<__duckvil_resource_argument_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*,Duckvil::RuntimeReflection::__duckvil_resource_type_t,Duckvil::RuntimeReflection::__duckvil_resource_function_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetFunctionArguments), "m_fnGetFunctionArguments");
...
_property = record_property<Memory::Vector<__duckvil_resource_inheritance_t>(*)(Duckvil::RuntimeReflection::__data*,Memory::ftable*,Memory::free_list_allocator*,Duckvil::RuntimeReflection::__duckvil_resource_type_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetInheritances), "m_fnGetInheritances");
...
_property = record_property<Memory::Vector<__duckvil_resource_meta_t>(*)(Memory::FreeList const&,Duckvil::RuntimeReflection::__data*,Duckvil::RuntimeReflection::__duckvil_resource_type_t)>(_data, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetTypeMetas), "m_fnGetTypeMetas");
