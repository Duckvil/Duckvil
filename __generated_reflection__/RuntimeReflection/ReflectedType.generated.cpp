...
_function = record_function<Duckvil::RuntimeReflection::ReflectedProperty, Duckvil::RuntimeReflection::__duckvil_resource_property_t const&>(_data, _type, &Duckvil::RuntimeReflection::ReflectedProperty::GetHandle, "GetHandle");
...
_function = record_function<Duckvil::RuntimeReflection::IReflectedFunction, Duckvil::RuntimeReflection::__duckvil_resource_function_t const&>(_data, _type, &Duckvil::RuntimeReflection::IReflectedFunction::GetHandle, "GetHandle");
...
record_namespace(_data, _type, "RuntimeReflection");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 9);
_constructor = record_constructor<Duckvil::RuntimeReflection::ReflectedType, Duckvil::RuntimeReflection::__duckvil_resource_type_t const&>(_data, _type);
...
_function = record_function<Duckvil::RuntimeReflection::ReflectedType, Duckvil::RuntimeReflection::__duckvil_resource_type_t const&>(_data, _type, &Duckvil::RuntimeReflection::ReflectedType::GetHandle, "GetHandle");
...
_function = record_function<Duckvil::RuntimeReflection::ReflectedType, Duckvil::RuntimeReflection::IReflectedFunction, RuntimeReflection::__duckvil_resource_function_t const&>(_data, _type, &Duckvil::RuntimeReflection::ReflectedType::GetFunction, "GetFunction");
