...
_property = record_property<duckvil_frontend_reflection_context*(*)(Memory::IMemory*, Memory::__free_list_allocator*, __ftable*, __data*)>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnCreateContext), "m_fnCreateContext");
...
_property = record_property<Memory::Vector<DUCKVIL_RESOURCE(function_t)>(*)(__data*, Memory::IMemory*, Memory::__free_list_allocator*, DUCKVIL_RESOURCE(type_t))>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::RuntimeReflection::__ftable, m_fnGetFunctions), "m_fnGetFunctions");
