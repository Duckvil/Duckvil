...
_property = record_property<char>(_data, _type, offsetof(Duckvil::RuntimeReflection::__generator_namespace, m_sName), "m_sName");
...
record_namespace(_data, _type, "RuntimeReflection");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 2);
_property = record_property<std::queue<__generator_namespace>>(_data, _type, offsetof(Duckvil::RuntimeReflection::__generator_data, m_aNamespaces), "m_aNamespaces");
...
_property = record_property<char>(_data, _type, offsetof(Duckvil::RuntimeReflection::__generator_data, m_sInclude), "m_sInclude");
