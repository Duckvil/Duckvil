...
_function = record_function<Duckvil::Editor::NetworkDebugger, bool, const Duckvil::Network::Message&>(_data, _type, &Duckvil::Editor::NetworkDebugger::OnMessage, "OnMessage");
