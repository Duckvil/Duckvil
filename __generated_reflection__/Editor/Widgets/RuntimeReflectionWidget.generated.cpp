...
_constructor = record_constructor<Duckvil::Editor::RuntimeReflectionWidget, Memory::FreeList const&>(_data, _type);
record_meta(_data, _type, _constructor, 0, "Size", 1024*1024);
