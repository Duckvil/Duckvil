...
_constructor = record_constructor<Duckvil::Editor::HexEditorWidget, Memory::FreeList const&>(_data, _type);
...
_function = record_function<Duckvil::Editor::HexEditorWidget, void, Duckvil::Editor::HexEditorWidgetInitEvent const&>(_data, _type, &Duckvil::Editor::HexEditorWidget::OnEvent, "OnEvent");
