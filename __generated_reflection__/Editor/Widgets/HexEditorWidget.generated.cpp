...
_function = record_function<Duckvil::Editor::HexEditorWidget, void, HexEditorWidgetInitEvent const&>(_data, _type, &Duckvil::Editor::HexEditorWidget::OnEvent, "OnEvent");
