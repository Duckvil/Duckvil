...
_constructor = record_constructor<Duckvil::Editor::EntityInspectorWidget, const Memory::FreeList&, Event::Pool<Event::mode::immediate>*, EntityFactory*, Event::Pool<Event::mode::immediate>*>(_data, _type);
...
_function = record_function<Duckvil::Editor::EntityInspectorWidget, void, const EntitySelectedEvent&>(_data, _type, &Duckvil::Editor::EntityInspectorWidget::OnEvent, "OnEvent");
_function = record_function<Duckvil::Editor::EntityInspectorWidget, void, const HotReloader::SwapEvent&>(_data, _type, &Duckvil::Editor::EntityInspectorWidget::OnEvent, "OnEvent");
_function = record_function<Duckvil::Editor::EntityInspectorWidget, void, const ProjectManager::OnLoadEvent&>(_data, _type, &Duckvil::Editor::EntityInspectorWidget::OnEvent, "OnEvent");
