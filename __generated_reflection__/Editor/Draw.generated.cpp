...
_property = record_property<void(Widget::*)(void*, const duckvil_frontend_reflection_context&)>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Editor::Draw, m_fnInit), "m_fnInit");
_property = record_property<HotReloader::ITrackKeeper*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Editor::Draw, m_pObject), "m_pObject");
