...
_property = record_property<void(Widget::*)()>(_data, _type, offsetof(Duckvil::Editor::HotDraw, m_fnDraw), "m_fnDraw");
_property = record_property<void(Widget::*)()>(_data, _type, offsetof(Duckvil::Editor::HotDraw, m_fnDrawMainMenu), "m_fnDrawMainMenu");
_property = record_property<void(Widget::*)(void*)>(_data, _type, offsetof(Duckvil::Editor::HotDraw, m_fnInit), "m_fnInit");
_property = record_property<DUCKVIL_TRACK_KEEPER_OBJECT(Widget)>(_data, _type, offsetof(Duckvil::Editor::HotDraw, m_pTrackKeeper), "m_pTrackKeeper");
...
record_namespace(_data, _type, "Editor");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<void(Widget::*)()>(_data, _type, offsetof(Duckvil::Editor::Draw, m_fnDraw), "m_fnDraw");
_property = record_property<void(Widget::*)()>(_data, _type, offsetof(Duckvil::Editor::Draw, m_fnDrawMainMenu), "m_fnDrawMainMenu");
_property = record_property<void(Widget::*)(void*)>(_data, _type, offsetof(Duckvil::Editor::Draw, m_fnInit), "m_fnInit");
