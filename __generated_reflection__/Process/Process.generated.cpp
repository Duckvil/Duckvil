...
record_namespace(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, "Process");
record_meta(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 2);
_property = record_property<void(*)(Duckvil::Memory::ftable*, Duckvil::Memory::free_list_allocator*, data*)>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Process::ftable, m_fnInit), "m_fnInit");
...
return duckvil_recorded_types_create(_pMemoryInterface, _pAllocator, _recordedTypes, "Process/Process.h", 2);
}
