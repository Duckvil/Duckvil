...
record_namespace(_data, _type, "Process");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 2);
_property = record_property<void(*)(Duckvil::Memory::ftable const*,Duckvil::Memory::free_list_allocator*,data*)>(_data, _type, offsetof(Duckvil::Process::ftable, m_fnInit), "m_fnInit");
...
_property = record_property<void(*)(data*,char const*)>(_data, _type, offsetof(Duckvil::Process::ftable, m_fnWrite), "m_fnWrite");
_property = record_property<bool(*)(data*)>(_data, _type, offsetof(Duckvil::Process::ftable, m_fnTerminate), "m_fnTerminate");
_property = record_property<void(*)(Duckvil::Memory::ftable const*,Duckvil::Memory::free_list_allocator*,data*)>(_data, _type, offsetof(Duckvil::Process::ftable, m_fnCleanup), "m_fnCleanup");
_namespaces.pop_back();
_namespaces.pop_back();
}
_namespaces.pop_back();
