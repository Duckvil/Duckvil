...
record_function<Duckvil::Utils::string, char&, int>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::Utils::string::operator, "operator");
record_function<Duckvil::Utils::string, char, int>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::Utils::string::operator, "operator");
return duckvil_recorded_types_create(_pMemoryInterface, _pAllocator, _recordedTypes, "Utils/Utils.h", 5);
}
