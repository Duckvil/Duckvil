...
_namespaces.push_back("__GLsync");
...
_constructor = record_constructor<Duckvil::Utils::Graphics::FrameBufferReader, Memory::ftable const*, Memory::free_list_allocator*, uint32_t, uint32_t, Format, Type>(_data, _type);
_constructor = record_constructor<Duckvil::Utils::Graphics::FrameBufferReader, FrameBufferReader const&>(_data, _type);
_constructor = record_constructor<Duckvil::Utils::Graphics::FrameBufferReader, FrameBufferReader&&>(_data, _type);
_destructor = record_destructor<Duckvil::Utils::Graphics::FrameBufferReader>(_data, _type);
_function = record_function<Duckvil::Utils::Graphics::FrameBufferReader, FrameBufferReader&, FrameBufferReader const&>(_data, _type, &Duckvil::Utils::Graphics::FrameBufferReader::operator=, "operator=");
_function = record_function<Duckvil::Utils::Graphics::FrameBufferReader, FrameBufferReader&, FrameBufferReader&&>(_data, _type, &Duckvil::Utils::Graphics::FrameBufferReader::operator=, "operator=");
