...
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 22);
record_inheritance<allocator>(_data, _type, __protection::__protection_public);
_property = record_property<Duckvil::Memory::__free_list_node*>(_data, _type, offsetof(Duckvil::Memory::free_list_allocator, m_pHead), "m_pHead");
_namespaces.pop_back();
...
_property = record_property<Duckvil::Memory::ftable::_stack_allocate_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackAllocate_), "m_fnStackAllocate_");
_property = record_property<Duckvil::Memory::ftable::_stack_allocate_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackAllocateSize_), "m_fnStackAllocateSize_");
_property = record_property<Duckvil::Memory::ftable::_stack_top_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackTop_), "m_fnStackTop_");
_property = record_property<Duckvil::Memory::ftable::_stack_pop_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackPop_), "m_fnStackPop_");
_property = record_property<Duckvil::Memory::ftable::_stack_empty_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackEmpty_), "m_fnStackEmpty_");
_property = record_property<Duckvil::Memory::ftable::_stack_full_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackFull_), "m_fnStackFull_");
_property = record_property<Duckvil::Memory::ftable::_stack_clear_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackClear_), "m_fnStackClear_");
_property = record_property<Duckvil::Memory::ftable::_stack_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackSize_), "m_fnStackSize_");
_property = record_property<Duckvil::Memory::ftable::_stack_capacity_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnStackCapacity_), "m_fnStackCapacity_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_allocate_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackAllocate_), "m_fnFixedStackAllocate_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_allocate_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackAllocateSize_), "m_fnFixedStackAllocateSize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_top_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackTop_), "m_fnFixedStackTop_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_pop_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackPop_), "m_fnFixedStackPop_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_empty_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackEmpty_), "m_fnFixedStackEmpty_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_full_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackFull_), "m_fnFixedStackFull_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_clear_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackClear_), "m_fnFixedStackClear_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackSize_), "m_fnFixedStackSize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_stack_capacity_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedStackCapacity_), "m_fnFixedStackCapacity_");
_property = record_property<Duckvil::Memory::ftable::_queue_allocate_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueAllocate_), "m_fnQueueAllocate_");
_property = record_property<Duckvil::Memory::ftable::_queue_allocate_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueAllocateSize_), "m_fnQueueAllocateSize_");
_property = record_property<Duckvil::Memory::ftable::_queue_begin_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueBegin_), "m_fnQueueBegin_");
_property = record_property<Duckvil::Memory::ftable::_queue_pop_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueuePop_), "m_fnQueuePop_");
_property = record_property<Duckvil::Memory::ftable::_queue_empty_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueEmpty_), "m_fnQueueEmpty_");
_property = record_property<Duckvil::Memory::ftable::_queue_full_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueFull_), "m_fnQueueFull_");
_property = record_property<Duckvil::Memory::ftable::_queue_clear_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueClear_), "m_fnQueueClear_");
_property = record_property<Duckvil::Memory::ftable::_queue_resize_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueResize_), "m_fnQueueResize_");
_property = record_property<Duckvil::Memory::ftable::_queue_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueSize_), "m_fnQueueSize_");
_property = record_property<Duckvil::Memory::ftable::_queue_capacity_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnQueueCapacity_), "m_fnQueueCapacity_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_allocate_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueAllocate_), "m_fnFixedQueueAllocate_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_allocate_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueAllocateSize_), "m_fnFixedQueueAllocateSize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_begin_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueBegin_), "m_fnFixedQueueBegin_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_pop_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueuePop_), "m_fnFixedQueuePop_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_empty_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueEmpty_), "m_fnFixedQueueEmpty_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_full_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueFull_), "m_fnFixedQueueFull_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_clear_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueClear_), "m_fnFixedQueueClear_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_resize_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueResize_), "m_fnFixedQueueResize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueSize_), "m_fnFixedQueueSize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_queue_capacity_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedQueueCapacity_), "m_fnFixedQueueCapacity_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_allocate_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayAllocate_), "m_fnFixedArrayAllocate_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_allocate_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayAllocateSize_), "m_fnFixedArrayAllocateSize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_begin_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayBegin_), "m_fnFixedArrayBegin_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_back_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayBack_), "m_fnFixedArrayBack_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_at_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayAt_), "m_fnFixedArrayAt_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_empty_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayEmpty_), "m_fnFixedArrayEmpty_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_full_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayFull_), "m_fnFixedArrayFull_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArraySize_), "m_fnFixedArraySize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_array_clear_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedArrayClear_), "m_fnFixedArrayClear_");
...
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_allocate_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorAllocate_), "m_fnFixedVectorAllocate_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_allocate_size_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorAllocateSize_), "m_fnFixedVectorAllocateSize_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_begin_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorBegin_), "m_fnFixedVectorBegin_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_back_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorBack_), "m_fnFixedVectorBack_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_end_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorEnd_), "m_fnFixedVectorEnd_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_at_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorAt_), "m_fnFixedVectorAt_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_empty_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorEmpty_), "m_fnFixedVectorEmpty_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_full_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorFull_), "m_fnFixedVectorFull_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_clear_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorClear_), "m_fnFixedVectorClear_");
_property = record_property<Duckvil::Memory::ftable::_fixed_vector_resize_>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnFixedVectorResize_), "m_fnFixedVectorResize_");
...
_property = record_property<Duckvil::Memory::ftable::_byte_buffer_seek_to_begin>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnByteBufferSeekToBegin_), "m_fnByteBufferSeekToBegin_");
_property = record_property<Duckvil::Memory::ftable::_byte_buffer_seek_to_end>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnByteBufferSeekToEnd_), "m_fnByteBufferSeekToEnd_");
_property = record_property<Duckvil::Memory::ftable::_byte_buffer_advance>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnByteBufferAdvance_), "m_fnByteBufferAdvance_");
_property = record_property<Duckvil::Memory::ftable::_byte_buffer_write>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnByteBufferWrite_), "m_fnByteBufferWrite_");
_property = record_property<Duckvil::Memory::ftable::_byte_buffer_read>(_data, _type, offsetof(Duckvil::Memory::ftable, m_fnByteBufferRead_), "m_fnByteBufferRead_");
