...
record_meta(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 18);
record_inheritance<allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, __protection::__protection_public);
_property = record_property<void*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::free_list_allocator, m_pHead), "m_pHead");
...
_property = record_property<IMemory::_fixed_stack_size_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedStackSize_), "m_fnFixedStackSize_");
_property = record_property<IMemory::_fixed_stack_capacity_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedStackCapacity_), "m_fnFixedStackCapacity_");
...
_property = record_property<IMemory::_fixed_queue_size_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedQueueSize_), "m_fnFixedQueueSize_");
_property = record_property<IMemory::_fixed_queue_capacity_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedQueueCapacity_), "m_fnFixedQueueCapacity_");
...
_property = record_property<IMemory::_fixed_vector_end_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedVectorEnd_), "m_fnFixedVectorEnd_");
...
_property = record_property<IMemory::_linear_allocate_linear_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateLinearAllocator), "m_fnLinearAllocateLinearAllocator");
_property = record_property<IMemory::_linear_allocate_fixed_stack_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateFixedStackAllocator), "m_fnLinearAllocateFixedStackAllocator");
_property = record_property<IMemory::_linear_allocate_fixed_array_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateFixedArrayAllocator), "m_fnLinearAllocateFixedArrayAllocator");
_property = record_property<IMemory::_linear_allocate_free_list_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateFreeListAllocator), "m_fnLinearAllocateFreeListAllocator");
_property = record_property<IMemory::_linear_allocate_fixed_vector_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateFixedVectorAllocator), "m_fnLinearAllocateFixedVectorAllocator");
