...
_property = record_property<std::size_t>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::__allocator, capacity), "capacity");
_property = record_property<std::size_t>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::__allocator, used), "used");
_property = record_property<uint8_t*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::__allocator, memory), "memory");
...
_type = record_type<Duckvil::Memory::__stack_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, "__stack_allocator");
record_namespace(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, "Duckvil");
record_namespace(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, "Memory");
record_inheritance(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, get_type<__allocator>(_pData), __protection::__protection_public);
...
_type = record_type<Duckvil::Memory::__queue_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, "__queue_allocator");
record_namespace(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, "Duckvil");
record_namespace(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, "Memory");
record_inheritance(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, get_type<__allocator>(_pData), __protection::__protection_public);
_property = record_property<std::size_t>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::__queue_allocator, m_ullTail), "m_ullTail");
_property = record_property<std::size_t>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::__queue_allocator, m_ullHead), "m_ullHead");
...
_property = record_property<IMemory::_linear_allocate_cstr>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateCStr), "m_fnLinearAllocateCStr");
...
_property = record_property<IMemory::_linear_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnLinearAllocateCStr_), "m_fnLinearAllocateCStr_");
...
_property = record_property<IMemory::_fixed_stack_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedStackAllocateCStr_), "m_fnFixedStackAllocateCStr_");
...
_property = record_property<IMemory::_stack_allocate_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackAllocate_), "m_fnStackAllocate_");
_property = record_property<IMemory::_stack_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackAllocateCStr_), "m_fnStackAllocateCStr_");
_property = record_property<IMemory::_stack_top_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackTop_), "m_fnStackTop_");
_property = record_property<IMemory::_stack_pop_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackPop_), "m_fnStackPop_");
_property = record_property<IMemory::_stack_empty_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackEmpty_), "m_fnStackEmpty_");
_property = record_property<IMemory::_stack_full_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackFull_), "m_fnStackFull_");
_property = record_property<IMemory::_stack_clear_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnStackClear_), "m_fnStackClear_");
...
_property = record_property<IMemory::_fixed_queue_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedQueueAllocateCStr_), "m_fnFixedQueueAllocateCStr_");
...
_property = record_property<IMemory::_queue_allocate_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueueAllocate_), "m_fnQueueAllocate_");
_property = record_property<IMemory::_queue_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueueAllocateCStr_), "m_fnQueueAllocateCStr_");
_property = record_property<IMemory::_queue_begin_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueueBegin_), "m_fnQueueBegin_");
_property = record_property<IMemory::_queue_pop_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueuePop_), "m_fnQueuePop_");
_property = record_property<IMemory::_queue_empty_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueueEmpty_), "m_fnQueueEmpty_");
_property = record_property<IMemory::_queue_full_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueueFull_), "m_fnQueueFull_");
_property = record_property<IMemory::_queue_clear_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnQueueClear_), "m_fnQueueClear_");
...
_property = record_property<IMemory::_fixed_array_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedArrayAllocateCStr_), "m_fnFixedArrayAllocateCStr_");
...
_property = record_property<IMemory::_free_list_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFreeListAllocateCStr_), "m_fnFreeListAllocateCStr_");
...
_property = record_property<IMemory::_fixed_vector_allocate_cstr_>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFixedVectorAllocateCStr_), "m_fnFixedVectorAllocateCStr_");
...
_property = record_property<IMemory::_allocate_stack_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnAllocateStackAllocator), "m_fnAllocateStackAllocator");
...
_property = record_property<IMemory::_allocate_queue_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnAllocateQueueAllocator), "m_fnAllocateQueueAllocator");
...
_property = record_property<IMemory::__free_list_allocate_vector_allocator>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Memory::IMemory, m_fnFreeListAllocateVectorAllocator), "m_fnFreeListAllocateVectorAllocator");
}
