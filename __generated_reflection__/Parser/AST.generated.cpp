...
_enumElement = record_enum_element(_data, _ntype, _enum, Duckvil::Parser::__ast_entity_type::__ast_entity_namespace_alias, "__ast_entity_namespace_alias");
_enumElement = record_enum_element(_data, _ntype, _enum, Duckvil::Parser::__ast_entity_type::__ast_entity_type_alias, "__ast_entity_type_alias");
...
_property = record_property<std::vector<__ast_entity *>>(_data, _type, offsetof(Duckvil::Parser::__ast_entity, m_aNamepaceAliases), "m_aNamepaceAliases");
_property = record_property<std::vector<__ast_entity *>>(_data, _type, offsetof(Duckvil::Parser::__ast_entity, m_aTypeAliases), "m_aTypeAliases");
_namespaces.pop_back();
_namespaces.push_back("__ast_entity_namespace_alias");
_ntype = record_type(_data, _namespaces);
_recordedNTypes.push_back(_ntype);
_type = record_type<Duckvil::Parser::__ast_entity_namespace_alias>(_data, "__ast_entity_namespace_alias");
_recordedTypes.push_back(_type);
record_namespace(_data, _type, "Duckvil");
record_namespace(_data, _type, "Parser");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
record_inheritance<__ast_entity>(_data, _type, __protection::__protection_public);
_constructor = record_constructor<Duckvil::Parser::__ast_entity_namespace_alias, __ast_entity_type>(_data, _type);
_property = record_property<std::string>(_data, _type, offsetof(Duckvil::Parser::__ast_entity_namespace_alias, m_sName), "m_sName");
_property = record_property<std::string>(_data, _type, offsetof(Duckvil::Parser::__ast_entity_namespace_alias, m_sTarget), "m_sTarget");
_namespaces.pop_back();
_namespaces.push_back("__ast_entity_type_alias");
_ntype = record_type(_data, _namespaces);
_recordedNTypes.push_back(_ntype);
_type = record_type<Duckvil::Parser::__ast_entity_type_alias>(_data, "__ast_entity_type_alias");
_recordedTypes.push_back(_type);
record_namespace(_data, _type, "Duckvil");
record_namespace(_data, _type, "Parser");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
record_inheritance<__ast_entity>(_data, _type, __protection::__protection_public);
_constructor = record_constructor<Duckvil::Parser::__ast_entity_type_alias, __ast_entity_type>(_data, _type);
_property = record_property<std::string>(_data, _type, offsetof(Duckvil::Parser::__ast_entity_type_alias, m_sName), "m_sName");
_property = record_property<std::string>(_data, _type, offsetof(Duckvil::Parser::__ast_entity_type_alias, m_sTarget), "m_sTarget");
_namespaces.pop_back();
...
_property = record_property<__behavior(*)(__ast*,__lexer_ftable*,__lexer_data*,std::string const&,std::string*)>(_data, _type, offsetof(Duckvil::Parser::user_define, m_fnBehavior), "m_fnBehavior");
_namespaces.pop_back();
_namespaces.push_back("__ast");
_ntype = record_type(_data, _namespaces);
_recordedNTypes.push_back(_ntype);
