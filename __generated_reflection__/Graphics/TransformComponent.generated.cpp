...
_function = record_function<void, const char*, glm::vec3*>(_data, _type, &Duckvil::Graphics::TransformComponent::Draw, "Draw");
_function = record_function<void, const char*, glm::quat*>(_data, _type, &Duckvil::Graphics::TransformComponent::Draw, "Draw");
...
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<bool, const Entity&>(_data, _type, &Duckvil::Graphics::TransformComponent::Has, "Has");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<uint8_t*, const Entity&>(_data, _type, &Duckvil::Graphics::TransformComponent::Get, "Get");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
