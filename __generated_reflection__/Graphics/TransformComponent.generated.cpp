...
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<void, nlohmann::json&, const ECS::Entity&>(_data, _type, &Duckvil::Graphics::TransformComponent::Serialize, "Serialize");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<void, const nlohmann::json&, ECS::Entity&>(_data, _type, &Duckvil::Graphics::TransformComponent::Deserialize, "Deserialize");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<bool, const ECS::Entity&>(_data, _type, &Duckvil::Graphics::TransformComponent::Has, "Has");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<uint8_t*, const ECS::Entity&>(_data, _type, &Duckvil::Graphics::TransformComponent::Get, "Get");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
