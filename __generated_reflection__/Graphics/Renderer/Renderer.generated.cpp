...
_enumElement = record_enum_element(_data, _ntype, _enum, Duckvil::Graphics::Renderer::renderer_op_code::renderer_op_code_read_pixels, "renderer_op_code_read_pixels");
...
_property = record_property<const void*>(_data, _type, offsetof(Duckvil::Graphics::Renderer::vertex_buffer_object_descriptor, m_pData), "m_pData");
...
_constructor = record_constructor<Duckvil::Graphics::Renderer::vertex_buffer_object_descriptor, GLenum, uint32_t, const void*, uint32_t, uint16_t>(_data, _type);
_namespaces.pop_back();
...
record_namespace(_data, _type, "Renderer");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 3);
_property = record_property<DUCKVIL_SLOT_ARRAY(shader)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_data, m_shader), "m_shader");
_property = record_property<DUCKVIL_SLOT_ARRAY(texture)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_data, m_texture), "m_texture");
_property = record_property<DUCKVIL_SLOT_ARRAY(texture_object)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_data, m_textureObject), "m_textureObject");
_property = record_property<DUCKVIL_SLOT_ARRAY(framebuffer)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_data, m_fbo), "m_fbo");
_property = record_property<DUCKVIL_SLOT_ARRAY(vertex_array_object)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_data, m_vao), "m_vao");
_property = record_property<DUCKVIL_SLOT_ARRAY(uniform)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_data, m_uniform), "m_uniform");
...
record_namespace(_data, _type, "Renderer");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 3);
_property = record_property<bool(*)(Memory::ftable*, Memory::free_list_allocator*, Window::IWindow*, renderer_data*)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnInit), "m_fnInit");
_property = record_property<void(*)(Memory::ftable*, renderer_data*)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnUpdate), "m_fnUpdate");
_property = record_property<void(*)(Memory::ftable*, renderer_data*)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnSubmitCommandBuffer), "m_fnSubmitCommandBuffer");
...
_property = record_property<uint32_t(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, const char*, const char*)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnCreateShader), "m_fnCreateShader");
_property = record_property<uint32_t(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, const texture_descriptor&)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnCreateTexture), "m_fnCreateTexture");
_property = record_property<uint32_t(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, const texture_object_descriptor&)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnCreateTextureObject), "m_fnCreateTextureObject");
_property = record_property<uint32_t(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, const framebuffer_descriptor&)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnCreateFramebuffer), "m_fnCreateFramebuffer");
_property = record_property<uint32_t(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, const vertex_array_object_descriptor&)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnCreateVAO), "m_fnCreateVAO");
_property = record_property<void(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, uint32_t)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnDestroyTexture), "m_fnDestroyTexture");
_property = record_property<void(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, uint32_t)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnDestroyFramebuffer), "m_fnDestroyFramebuffer");
_property = record_property<uint32_t(*)(Memory::ftable*, Memory::free_list_allocator*, renderer_data*, uint32_t, const char*)>(_data, _type, offsetof(Duckvil::Graphics::Renderer::renderer_ftable, m_fnGetUniformLocation), "m_fnGetUniformLocation");
