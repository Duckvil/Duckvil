...
_function = record_function<Duckvil::Network::IClient, bool, std::string const&, uint16_t const>(_data, _type, &Duckvil::Network::IClient::Connect, "Connect");
...
_function = record_function<Duckvil::Network::IClient, void, Duckvil::Network::NetworkSystem*>(_data, _type, &Duckvil::Network::IClient::AddSystem, "AddSystem");
_function = record_function<Duckvil::Network::IClient, tsqueue<Duckvil::Network::OwnedMessage>&>(_data, _type, &Duckvil::Network::IClient::Incoming, "Incoming");
_function = record_function<Duckvil::Network::IClient, void, Duckvil::Network::Message const&>(_data, _type, &Duckvil::Network::IClient::Send, "Send");
