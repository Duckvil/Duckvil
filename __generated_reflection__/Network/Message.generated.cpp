...
record_namespace(_data, _type, "Network");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 5);
_property = record_property<MessageType>(_data, _type, offsetof(Duckvil::Network::MessageHeader, m_id), "m_id");
...
record_namespace(_data, _type, "Network");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 5);
_property = record_property<MessageHeader>(_data, _type, offsetof(Duckvil::Network::Message, m_header), "m_header");
...
_property = record_property<Message>(_data, _type, offsetof(Duckvil::Network::OwnedMessage, m_message), "m_message");
_namespaces.pop_back();
_namespaces.pop_back();
}
_namespaces.pop_back();
