...
_constructor = record_constructor<Duckvil::Network::Client, const Memory::FreeList&>(_data, _type);
_destructor = record_destructor<Duckvil::Network::Client>(_data, _type);
_function = record_function<Duckvil::Network::Client, bool, const std::string&, const uint16_t>(_data, _type, &Duckvil::Network::Client::Connect, "Connect");
...
_function = record_function<Duckvil::Network::Client, void, const Message&>(_data, _type, &Duckvil::Network::Client::Send, "Send");
