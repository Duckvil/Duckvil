...
void Duckvil::ProjectManager::data::Push(DependencyInjection::IDependencyInjector* _pFAP, const void* _pData)
{
	_pFAP->Push(*static_cast<const data*>(_pData));
}
void Duckvil::ProjectManager::ftable::Push(DependencyInjection::IDependencyInjector* _pFAP, const void* _pData)
{
	_pFAP->Push(*static_cast<const data*>(_pData));
}
...
_function = record_function<void, Duckvil::DependencyInjection::IDependencyInjector*, const void*>(_data, _type, &Duckvil::ProjectManager::data::Push, "Push");
...
_function = record_function<void, Duckvil::DependencyInjection::IDependencyInjector*, const void*>(_data, _type, &Duckvil::ProjectManager::ftable::Push, "Push");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
