...
_property = record_property<HotReloader::FileWatcher*>(_data, _type, offsetof(Duckvil::ProjectManager::data, m_pFileWatcher), "m_pFileWatcher");
...
_property = record_property<RuntimeReflection::__function<data::CompileCallback>*>(_data, _type, offsetof(Duckvil::ProjectManager::data, m_fnCompile), "m_fnCompile");
_property = record_property<Duckvil::RuntimeReflection::__duckvil_resource_type_t>(_data, _type, offsetof(Duckvil::ProjectManager::data, m_fileWatcherType), "m_fileWatcherType");
_property = record_property<Duckvil::RuntimeReflection::__duckvil_resource_function_t>(_data, _type, offsetof(Duckvil::ProjectManager::data, m_watchHandle), "m_watchHandle");
_property = record_property<Duckvil::RuntimeReflection::__duckvil_resource_function_t>(_data, _type, offsetof(Duckvil::ProjectManager::data, m_updateHandle), "m_updateHandle");
...
_property = record_property<void(*)(data*, HotReloader::RuntimeCompilerSystem*)>(_data, _type, offsetof(Duckvil::ProjectManager::ftable, m_fnSetRuntimeCompiler), "m_fnSetRuntimeCompiler");
_namespaces.pop_back();
_namespaces.pop_back();
}
_namespaces.pop_back();
