...
_property = record_property<bool(*)(BufferedChannel*)>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, offsetof(Duckvil::Event::Channel::Channel::BufferedChannel, m_fnAnyEvents), "m_fnAnyEvents");
