...
record_function<Duckvil::HotReloader::TrackKeeper, void, const HotReloadedEvent&>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::TrackKeeper::OnEvent, "OnEvent");
