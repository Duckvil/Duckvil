...
_function = record_function<Duckvil::HotReloader::TrackKeeper, void*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::TrackKeeper::GetObject, "GetObject");
_function = record_function<Duckvil::HotReloader::TrackKeeper, RuntimeReflection::__duckvil_resource_type_t>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::TrackKeeper::GetTypeHandle, "GetTypeHandle");
