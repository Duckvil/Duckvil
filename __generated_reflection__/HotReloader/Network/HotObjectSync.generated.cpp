...
_constructor = record_constructor<Duckvil::HotReloader::Network::HotObjectSync, Memory::FreeList const&, Duckvil::Network::IClient*, Duckvil::Network::IServer*, HotReloader::RuntimeCompilerSystem*>(_data, _type);
...
_function = record_function<Duckvil::HotReloader::Network::HotObjectSync, void, HotReloader::SwapEvent const&>(_data, _type, &Duckvil::HotReloader::Network::HotObjectSync::OnEvent, "OnEvent");
...
_function = record_function<Duckvil::HotReloader::Network::HotObjectSync, bool, Duckvil::Network::Message const&, std::shared_ptr<Duckvil::Network::IConnection>>(_data, _type, &Duckvil::HotReloader::Network::HotObjectSync::OnMessage, "OnMessage");
