...
_constructor = record_constructor<Duckvil::HotReloader::RuntimeCompilerReflectionModule>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type);
...
return duckvil_recorderd_types { _types, _recordedTypes.size(), "HotReloader/ReflectionModule.h", 3 };
}
