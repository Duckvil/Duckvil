...
_function = record_function<Duckvil::HotReloader::ITrackKeeper, void*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::ITrackKeeper::GetObject, "GetObject");
_function = record_function<Duckvil::HotReloader::ITrackKeeper, RuntimeReflection::__duckvil_resource_type_t>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::ITrackKeeper::GetTypeHandle, "GetTypeHandle");
