...
_constructor = record_constructor<Duckvil::HotReloader::RuntimeCompilerSystem, Memory::FreeList const&, Event::Pool<Event::mode::immediate>*, Event::Pool<Event::mode::immediate>*, FileWatcher::ActionCallback, void*, DependencyInjection::IDependencyResolver*>(_data, _type);
...
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, bool, bool>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Init, "Init");
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, bool, std::vector<std::filesystem::path> const&, bool>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Init, "Init");
...
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, bool, RuntimeCompilerSystem::hot_object*, RuntimeReflection::__duckvil_resource_type_t const&>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Swap, "Swap");
...
_function = record_function<void*, void*>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Cast, "Cast");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, Duckvil::RuntimeSerializer::ISerializer*>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Serialize, "Serialize");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_namespaces.pop_back();
