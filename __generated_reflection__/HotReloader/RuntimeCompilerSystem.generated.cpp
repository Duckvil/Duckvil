...
_constructor = record_constructor<Duckvil::HotReloader::RuntimeCompilerSystem, const Memory::FreeList&, Event::Pool<Event::mode::immediate>*, Event::Pool<Event::mode::immediate>*, FileWatcher::ActionCallback, void*>(_data, _type);
...
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, bool, const std::vector<std::filesystem::path>&>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Init, "Init");
...
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, const std::string&, const RuntimeCompiler::Options&>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Compile, "Compile");
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, const std::string&, const RuntimeCompiler::Options&>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::CompileT, "CompileT");
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, const std::filesystem::path&, const std::filesystem::path&, bool>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::GenerateReflection, "GenerateReflection");
...
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, const std::filesystem::path&>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::SetCWD, "SetCWD");
_function = record_function<Duckvil::HotReloader::RuntimeCompilerSystem, const std::filesystem::path&>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::GetCWD, "GetCWD");
