...
record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, double>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Update, "Update");
record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, void*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::InitEditor, "InitEditor");
record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::OnDraw, "OnDraw");
...
record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, Memory::Vector<PlugNPlay::__module_information>*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::SetModules, "SetModules");
record_function<Duckvil::HotReloader::RuntimeCompilerSystem, void, Memory::Vector<duckvil_recorderd_types>*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::SetReflectedTypes, "SetReflectedTypes");
