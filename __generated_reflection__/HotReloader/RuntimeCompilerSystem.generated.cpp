...
void Duckvil::HotReloader::RuntimeCompilerSystem::Push(DependencyInjection::IDependencyInjector* _pFAP, const void* _pData)
{
_pFAP->Push(*static_cast<const RuntimeCompilerSystem*>(_pData));
}
...
_function = record_function<void, Duckvil::DependencyInjection::IDependencyInjector*, const void*>(_data, _type, &Duckvil::HotReloader::RuntimeCompilerSystem::Push, "Push");
