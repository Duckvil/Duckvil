...
_property = record_property<const char*>(_data, _type, offsetof(Duckvil::CasterReflectionModule, m_sReflectionModuleName), "m_sReflectionModuleName");
_constructor = record_constructor<Duckvil::CasterReflectionModule, const Memory::FreeList&, RuntimeReflection::__ftable*, RuntimeReflection::__data*>(_data, _type);
...
_function = record_function<Duckvil::CasterReflectionModule, void, std::ofstream&, std::ofstream&, std::vector<std::pair<uint32_t,std::vector<std::string>>>&>(_data, _type, &Duckvil::CasterReflectionModule::GenerateCustom, "GenerateCustom");
