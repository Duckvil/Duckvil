...
_property = record_property<Duckvil::DependencyInjection::Scope>(_data, _type, offsetof(Duckvil::DependencyInjection::IDependencyResolver::Dependency, m_scope), "m_scope");
