...
_function = record_function<Duckvil::DependencyInjection::IDependencyResolver, bool, IDependencyResolver::Dependency const&>(_data, _type, &Duckvil::DependencyInjection::IDependencyResolver::Register, "Register");
_function = record_function<Duckvil::DependencyInjection::IDependencyResolver, bool, RuntimeReflection::__duckvil_resource_type_t const&, RuntimeReflection::__duckvil_resource_constructor_t const&, void**, bool>(_data, _type, &Duckvil::DependencyInjection::IDependencyResolver::Resolve, "Resolve");
...
_property = record_property<Scope>(_data, _type, offsetof(Duckvil::DependencyInjection::IDependencyResolver::Dependency, m_scope), "m_scope");
...
_property = record_property<Duckvil::DependencyInjection::IDependencyResolver::Dependency::DependencyFactory>(_data, _type, offsetof(Duckvil::DependencyInjection::IDependencyResolver::Dependency, m_fnFactory), "m_fnFactory");
_namespaces.pop_back();
