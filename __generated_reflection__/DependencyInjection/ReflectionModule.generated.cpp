...
_constructor = record_constructor<Duckvil::DependencyInjection::ReflectionModule, Memory::FreeList const&, RuntimeReflection::__ftable const*, RuntimeReflection::__data*>(_data, _type);
...
_property = record_property<RuntimeReflection::__ftable const*>(_data, _type, offsetof(Duckvil::DependencyInjection::ReflectionModule, m_pRuntimeReflection), "m_pRuntimeReflection");
