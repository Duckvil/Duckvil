...
record_function<Duckvil::Window::IWindow, bool>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::Window::IWindow::Create, "Create");
...
return duckvil_recorderd_types { _types, _recordedTypes.size(), "Window/IWindow.h", 1 };
}
