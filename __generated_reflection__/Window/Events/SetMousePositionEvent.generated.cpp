...
_ntype = record_type(_data, _namespaces);
_recordedNTypes.push_back(_ntype);
_namespaces.push_back("SetMousePositionEvent");
_ntype = record_type(_data, _namespaces);
_recordedNTypes.push_back(_ntype);
using namespace Duckvil::Window;
_type = record_type<Duckvil::Window::SetMousePositionEvent>(_data, "SetMousePositionEvent");
...
return duckvil_recorded_types_create(_data._pMemoryInterface, _data._pAllocator, _recordedTypes, "Window/Events/SetMousePositionEvent.h", 5);
}
