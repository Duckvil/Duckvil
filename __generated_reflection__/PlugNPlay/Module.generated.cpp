...
_constructor = record_constructor<Duckvil::PlugNPlay::__module_information, const Utils::string&>(_data, _type);
_constructor = record_constructor<Duckvil::PlugNPlay::__module_information, const Utils::string&, const Utils::string&>(_data, _type);
...
_property = record_property<bool(*)(const __module_information&, const char*, void**)>(_data, _type, offsetof(Duckvil::PlugNPlay::__module, get), "get");
