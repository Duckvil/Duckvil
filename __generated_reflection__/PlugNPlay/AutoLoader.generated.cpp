...
record_function<Duckvil::PlugNPlay::AutoLoader, void, Memory::ftable*, Memory::free_list_allocator*, __module_information**, uint32_t*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::PlugNPlay::AutoLoader::LoadAll, "LoadAll");
record_function<Duckvil::PlugNPlay::AutoLoader, void, Memory::ftable*, Memory::free_list_allocator*, Memory::Vector<__module_information>*>(DUCKVIL_RUNTIME_REFLECTION_RECORDER_STANDARD_STUFF, _type, &Duckvil::PlugNPlay::AutoLoader::LoadAll, "LoadAll");
