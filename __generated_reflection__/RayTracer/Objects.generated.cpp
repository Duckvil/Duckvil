...
record_namespace(_data, _type, "RayTracer");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<Duckvil::Graphics::RayTracer::ObjectType>(_data, _type, offsetof(Duckvil::Graphics::RayTracer::ObjectChunk, m_type), "m_type");
_property = record_property<uint32_t>(_data, _type, offsetof(Duckvil::Graphics::RayTracer::ObjectChunk, m_uiSize), "m_uiSize");
_property = record_property<Duckvil::Graphics::RayTracer::MaterialType>(_data, _type, offsetof(Duckvil::Graphics::RayTracer::ObjectChunk, m_material), "m_material");
_namespaces.pop_back();
...
record_namespace(_data, _type, "RayTracer");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<Duckvil::Graphics::RayTracer::LightType>(_data, _type, offsetof(Duckvil::Graphics::RayTracer::LightChunk, m_type), "m_type");
_namespaces.pop_back();
