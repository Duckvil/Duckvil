...
record_namespace(_data, _type, "Duckvil");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<logger_data(*)(Memory::FreeList const&)>(_data, _type, offsetof(Duckvil::logger_ftable, m_fnInitLogger), "m_fnInitLogger");
_property = record_property<__logger_channel_data*(*)(Memory::FreeList const&,logger_data*,logger_channel_descriptor const&,std::size_t,uint32_t)>(_data, _type, offsetof(Duckvil::logger_ftable, m_fnAdd), "m_fnAdd");
_property = record_property<void(*)(__logger_channel_ftable*,logger_data*,std::size_t,uint32_t,uint32_t,char const*,std::size_t,char const*,std::size_t,__logger_channel_verbosity,va_list)>(_data, _type, offsetof(Duckvil::logger_ftable, m_fnLog), "m_fnLog");
_namespaces.pop_back();
