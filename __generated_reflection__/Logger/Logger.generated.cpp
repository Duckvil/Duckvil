...
_property = record_property<Duckvil::__logger_channel_data*>(_data, _type, offsetof(Duckvil::logger_channel_lookup, m_pChannel), "m_pChannel");
...
record_namespace(_data, _type, "Duckvil");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<char const*>(_data, _type, offsetof(Duckvil::logger_channel_descriptor, m_sPathFile), "m_sPathFile");
_property = record_property<size_t>(_data, _type, offsetof(Duckvil::logger_channel_descriptor, m_ullLength), "m_ullLength");
_property = record_property<Duckvil::__logger_channel_flags>(_data, _type, offsetof(Duckvil::logger_channel_descriptor, m_flags), "m_flags");
_namespaces.pop_back();
...
record_namespace(_data, _type, "Duckvil");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<Duckvil::logger_data(*)(Memory::FreeList const&)>(_data, _type, offsetof(Duckvil::logger_ftable, m_fnInitLogger), "m_fnInitLogger");
_property = record_property<Duckvil::__logger_channel_data*(*)(Memory::FreeList const&,Duckvil::logger_data*,Duckvil::logger_channel_descriptor const&,std::size_t,uint32_t)>(_data, _type, offsetof(Duckvil::logger_ftable, m_fnAdd), "m_fnAdd");
_property = record_property<void(*)(Duckvil::__logger_channel_ftable*,Duckvil::logger_data*,std::size_t,uint32_t,uint32_t,char const*,std::size_t,char const*,std::size_t,Duckvil::__logger_channel_verbosity,va_list)>(_data, _type, offsetof(Duckvil::logger_ftable, m_fnLog), "m_fnLog");
_namespaces.pop_back();
...
record_namespace(_data, _type, "Duckvil");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<Duckvil::logger_ftable>(_data, _type, offsetof(Duckvil::logger_context, m_logger), "m_logger");
_property = record_property<Duckvil::logger_data>(_data, _type, offsetof(Duckvil::logger_context, m_loggerData), "m_loggerData");
_property = record_property<Duckvil::__logger_channel_ftable*>(_data, _type, offsetof(Duckvil::logger_context, m_pLoggerChannel), "m_pLoggerChannel");
