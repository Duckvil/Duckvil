...
_property = record_property<char[256]>(_data, _type, offsetof(Duckvil::__logger_channel_log_info, m_sFile), "m_sFile");
_property = record_property<char[256]>(_data, _type, offsetof(Duckvil::__logger_channel_log_info, m_sMessage), "m_sMessage");
...
record_namespace(_data, _type, "Duckvil");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 1);
_property = record_property<char[256]>(_data, _type, offsetof(Duckvil::__logger_channel_data, m_buffer), "m_buffer");
_property = record_property<char[128]>(_data, _type, offsetof(Duckvil::__logger_channel_data, m_sPathFile), "m_sPathFile");
...
_property = record_property<Duckvil::__logger_channel_flags>(_data, _type, offsetof(Duckvil::__logger_channel_data, m_flags), "m_flags");
_namespaces.pop_back();
