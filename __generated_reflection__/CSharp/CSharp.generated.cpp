...
_function = record_function<Duckvil::CSharp::CSharp, SharedScript*, RuntimeReflection::__duckvil_resource_type_t const&>(_data, _type, &Duckvil::CSharp::CSharp::Create, "Create");
_function = record_function<Duckvil::CSharp::CSharp, void, size_t*, SharedScript*>(_data, _type, &Duckvil::CSharp::CSharp::Register, "Register");
