...
_constructor = record_constructor<Duckvil::CSharp::ReflectionModule, Memory::FreeList const&, RuntimeReflection::__ftable*, RuntimeReflection::__data*>(_data, _type);
...
_property = record_property<RuntimeReflection::__ftable*>(_data, _type, offsetof(Duckvil::CSharp::ReflectionModule, m_pRuntimeReflection), "m_pRuntimeReflection");
