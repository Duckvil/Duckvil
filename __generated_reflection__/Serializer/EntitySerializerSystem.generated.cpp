...
_constructor = record_constructor<Duckvil::Serializer::EntitySerializerSystem, Memory::FreeList const&, Event::Pool<Event::mode::immediate>*, ECS::EntityFactory*>(_data, _type);
