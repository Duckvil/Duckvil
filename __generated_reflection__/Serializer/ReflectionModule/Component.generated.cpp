...
_constructor = record_constructor<Duckvil::Serializer::ReflectionModule::Component, Memory::FreeList const&, RuntimeReflection::__ftable*, RuntimeReflection::__data*>(_data, _type);
