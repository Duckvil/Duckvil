...
_property = record_property<const char*>(_data, _type, offsetof(Duckvil::Serializer::ReflectionModule::Component, m_sReflectionModuleName), "m_sReflectionModuleName");
_constructor = record_constructor<Duckvil::Serializer::ReflectionModule::Component, const Memory::FreeList&, RuntimeReflection::__ftable*, RuntimeReflection::__data*>(_data, _type);
