...
_function = record_function<Duckvil::RuntimeSerializer::Serializer, void, uint32_t, char const*>(_data, _type, &Duckvil::RuntimeSerializer::Serializer::Clear, "Clear");
...
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 5);
_function = record_function<Duckvil::RuntimeSerializer::Serializer::cmp_str, bool, char const*, char const*>(_data, _type, &Duckvil::RuntimeSerializer::Serializer::cmp_str::operator(), "operator()");
_namespaces.pop_back();
_namespaces.pop_back();
}
_namespaces.pop_back();
}
return duckvil_recorded_types_create(_data._pMemoryInterface, _data._pAllocator, _recordedTypes, "Serializer/Runtime/Serializer.h", 5);
}
