...
void Duckvil::EntityFactory::Push(DependencyInjection::IDependencyInjector* _pFAP, const void* _pData)
{
	_pFAP->Push(*static_cast<const EntityFactory*>(_pData));
}
...
_function = record_function<void, Duckvil::DependencyInjection::IDependencyInjector*, const void*>(_data, _type, &Duckvil::EntityFactory::Push, "Push");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<void*, void*>(_data, _type, &Duckvil::EntityFactory::Cast, "Cast");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
_function = record_function<Duckvil::EntityFactory, void, Duckvil::RuntimeSerializer::ISerializer*>(_data, _type, &Duckvil::EntityFactory::Serialize, "Serialize");
record_meta(_data, _type, _function, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_AutoGenerated, true);
