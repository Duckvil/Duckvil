...
_property = record_property<DependencyInjection::IDependencyInjector*>(_data, _type, offsetof(Duckvil::InjectConstructorArgumentEvent, m_pFAP), "m_pFAP");
_property = record_property<Duckvil::InjectConstructorArgumentEvent::Info>(_data, _type, offsetof(Duckvil::InjectConstructorArgumentEvent, m_info), "m_info");
...
_constructor = record_constructor<Duckvil::InjectConstructorArgumentEvent, DependencyInjection::IDependencyInjector*, InjectConstructorArgumentEvent::Info const&, RuntimeReflection::__argument_t const&>(_data, _type);
...
return duckvil_recorded_types_create(_data._pMemoryInterface, _data._pAllocator, _recordedTypes, "Engine/Events/InjectConstructorArgumentEvent.h", 6);
}
