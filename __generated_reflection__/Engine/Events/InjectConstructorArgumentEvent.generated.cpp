...
_property = record_property<Duckvil::FunctionArgumentsPusher*>(_data, _type, offsetof(Duckvil::InjectConstructorArgumentEvent, m_pFAP), "m_pFAP");
...
_constructor = record_constructor<Duckvil::InjectConstructorArgumentEvent, Duckvil::FunctionArgumentsPusher*, InjectConstructorArgumentEvent::Info const&, RuntimeReflection::__argument_t const&>(_data, _type);
