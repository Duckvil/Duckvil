...
_constructor = record_constructor<Duckvil::DummyReflectionModule, Memory::FreeList const&, RuntimeReflection::__ftable const*, RuntimeReflection::__data*>(_data, _type);
...
_property = record_property<RuntimeReflection::__ftable const*>(_data, _type, offsetof(Duckvil::DummyReflectionModule, m_pReflection), "m_pReflection");
