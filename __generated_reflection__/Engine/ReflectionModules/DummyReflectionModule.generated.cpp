...
_function = record_function<Duckvil::DummyReflectionModule, void, std::ofstream&, std::ofstream&, std::vector<std::pair<uint32_t,std::vector<std::string>>>&>(_data, _type, &Duckvil::DummyReflectionModule::GenerateCustom, "GenerateCustom");
