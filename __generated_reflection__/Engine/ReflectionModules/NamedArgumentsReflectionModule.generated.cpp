...
_property = record_property<RuntimeReflection::__ftable*>(_data, _type, offsetof(Duckvil::NamedArgumentsReflectionModule, m_pReflection), "m_pReflection");
...
_function = record_function<Duckvil::NamedArgumentsReflectionModule, void, std::ofstream&, std::ofstream&, std::vector<std::pair<uint32_t,std::vector<std::string>>>&>(_data, _type, &Duckvil::NamedArgumentsReflectionModule::GenerateCustom, "GenerateCustom");
...
return duckvil_recorded_types_create(_data._pMemoryInterface, _data._pAllocator, _recordedTypes, "Engine/ReflectionModules/NamedArgumentsReflectionModule.h", 10);
}
