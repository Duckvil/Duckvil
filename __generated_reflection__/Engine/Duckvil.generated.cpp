...
_property = record_property<Memory::ftable const*>(_data, _type, offsetof(Duckvil::__data, m_pMemory), "m_pMemory");
...
_property = record_property<RuntimeReflection::__ftable const*>(_data, _type, offsetof(Duckvil::__data, m_pRuntimeReflection), "m_pRuntimeReflection");
_property = record_property<RuntimeReflection::__recorder_ftable const*>(_data, _type, offsetof(Duckvil::__data, m_pRuntimeReflectionRecorder), "m_pRuntimeReflectionRecorder");
...
_property = record_property<ECS::EntityFactory>(_data, _type, offsetof(Duckvil::__data, m_entityFactory), "m_entityFactory");
...
record_namespace(_data, _type, "Duckvil");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_property = record_property<bool(*)(Duckvil::__data*,Memory::ftable const*,Memory::free_list_allocator*)>(_data, _type, offsetof(Duckvil::__ftable, init), "init");
