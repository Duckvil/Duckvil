...
record_namespace(_data, _type, "RuntimeCompiler");
record_meta(_data, _type, Duckvil::RuntimeReflection::GeneratedMeta::GeneratedMeta_RecorderID, 0);
_function = record_function<Duckvil::RuntimeCompiler::ICompiler, void, std::vector<std::string> const&, Options const&>(_data, _type, &Duckvil::RuntimeCompiler::ICompiler::Compile, "Compile");
