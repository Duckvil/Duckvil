        ...
        ImGui::Begin("Hex editor");
        {
            ...
            if(m_pSelected != nullptr)
            {
                ...
                case duckvil_memory_allocator_type::duckvil_memory_allocator_type_array:
                    m_hexEditor.DrawContents((uint8_t*)m_pSelected->m_pAllocator + sizeof(Memory::fixed_array_allocator), m_pSelected->m_pAllocator->m_ullCapacity);
                    break;
                case duckvil_memory_allocator_type::duckvil_memory_allocator_type_vector:
                    m_hexEditor.DrawContents((uint8_t*)m_pSelected->m_pAllocator + sizeof(Memory::fixed_vector_allocator), m_pSelected->m_pAllocator->m_ullCapacity);
                    break;
                case duckvil_memory_allocator_type::duckvil_memory_allocator_type_linear:
                    m_hexEditor.DrawContents((uint8_t*)m_pSelected->m_pAllocator + sizeof(Memory::linear_allocator), m_pSelected->m_pAllocator->m_ullCapacity);
                    break;
                case duckvil_memory_allocator_type::duckvil_memory_allocator_type_free_list:
                    m_hexEditor.DrawContents((uint8_t*)m_pSelected->m_pAllocator + sizeof(Memory::free_list_allocator), m_pSelected->m_pAllocator->m_ullCapacity);
                    break;
                case duckvil_memory_allocator_type::duckvil_memory_allocator_type_queue:
                    m_hexEditor.DrawContents((uint8_t*)m_pSelected->m_pAllocator + sizeof(Memory::fixed_queue_allocator), m_pSelected->m_pAllocator->m_ullCapacity);
                    break;
                case duckvil_memory_allocator_type::duckvil_memory_allocator_type_stack:
                    m_hexEditor.DrawContents((uint8_t*)m_pSelected->m_pAllocator + sizeof(Memory::fixed_stack_allocator), m_pSelected->m_pAllocator->m_ullCapacity);
                    break;
                default:
                    break;
                }
