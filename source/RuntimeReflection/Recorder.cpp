...
namespace Duckvil { namespace RuntimeReflection {
    ...
    DUCKVIL_RESOURCE(meta_t) record_constructor_argument_meta(Memory::ftable* _pMemoryInterface, Memory::free_list_allocator* _pAllocator, __data* _pData, DUCKVIL_RESOURCE(type_t) _typeHandle, DUCKVIL_RESOURCE(constructor_t) _owner, uint32_t _uiArgumentIndex, const __recorder_meta_info& _meta)
    {
        __type_t* _type = DUCKVIL_SLOT_ARRAY_GET_POINTER(_pData->m_aTypes, _typeHandle.m_ID);
...
Duckvil::RuntimeReflection::__recorder_ftable* duckvil_runtime_reflection_recorder_init()
{
    ...
    _functions.m_fnRecordConstructorArgumentMeta = &Duckvil::RuntimeReflection::record_constructor_argument_meta;
